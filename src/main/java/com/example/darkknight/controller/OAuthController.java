...
public class OAuthController {
    ...
    public String oauthCallback(@RequestParam(required = false) String code,
        ...
        try {
            ...
            // ==========================================
            // 6. Role-based redirect (matching AuthController)
            // ==========================================
            String redirectUrl;
            ...
            // Don't clear TenantContext here - let the interceptor handle it after redirect completes
     ...
     * Tries: TenantContext -> Session -> State parameter
     */
